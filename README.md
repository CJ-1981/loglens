...
![tests](https://img.shields.io/badge/assertions-478%20passing-green)
...
- **Current version**: v1.22.13 · see changelog for the full history; unit suites run via `npm test`
