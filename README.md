...
![tests](https://img.shields.io/badge/assertions-480%20passing-green)
...
- **Current version**: v1.22.14 · see changelog for the full history; unit suites run via `npm test`
