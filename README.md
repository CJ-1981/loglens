...
![version](https://img.shields.io/badge/version-v1.22.12-blue)
...
- **Current version**: v1.22.12 · see changelog for the full history; unit suites run via `npm test`
