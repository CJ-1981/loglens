...
![tests](https://img.shields.io/badge/assertions-477%20passing-green)
...
- **Current version**: v1.22.11 · see changelog for the full history; unit suites run via `npm test`
