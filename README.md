...
![tests](https://img.shields.io/badge/assertions-384%20passing-green)
...
- **Current version**: v1.18.8 · 384 automated assertions across 8 suites (`test_loglens.js` + `test_loglens_v15.js` + `test_viewer_ui.js` + `test_viewer_search.js` + `test_team_nav.js` + `test_team_denoise.js` + `test_team_workbench.js` + `test_team_marks.js`) · worker-accelerated scans · zebra log viewer · mobile-responsive
