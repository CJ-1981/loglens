...
![version](https://img.shields.io/badge/version-v1.22.10-blue)
![tests](https://img.shields.io/badge/assertions-476%20passing-green)
...
- **Current version**: v1.22.10 · see changelog for the full history; unit suites run via `npm test`
